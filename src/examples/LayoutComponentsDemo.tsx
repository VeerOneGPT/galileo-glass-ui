    ...
    <DemoContainer>
      ...
      <DemoSection>
        ...
        <Paper style={{ padding: '24px' }}>
          <Stack 
            spacing={2} 
            divider={<hr style={{ width: '100%', margin: 0, border: 'none', borderTop: '1px dashed rgba(0, 0, 0, 0.2)' }} />}
          >
            <DemoItem>Item 1</DemoItem>
            <DemoItem>Item 2</DemoItem>
            <DemoItem>Item 3</DemoItem>
      ...
      <DemoSection>
        ...
        <div style={{ position: 'relative', padding: '24px', background: 'linear-gradient(45deg, #2196F3, #21CBF3)' }}>
          <Stack
            ...
            style={{ padding: '24px' }}
          >
            <DemoItem style={{ background: 'transparent', border: '1px solid rgba(255, 255, 255, 0.3)', color: 'white' }}>
              Item 1
            </DemoItem>
            <DemoItem style={{ background: 'transparent', border: '1px solid rgba(255, 255, 255, 0.3)', color: 'white' }}>
              Item 2
