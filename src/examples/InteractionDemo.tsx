  ...
  return (
    <DemoContainer>
      ...
      <DemoSection>
        ...
        <Stack spacing={2}>
          ...
          <Box>
            ...
            <Link href="#" glass variant="button">
              Glass Link
            </Link>
          </Box>
          ...
          <Box>
            ...
            <Link href="#" animated glass variant="button">
              Animated Link
            </Link>
          </Box>
        </Stack>
        ...
        >
          ...
          >
            ...
            <Typography variant="body1" style={{ marginBottom: '24px' }}>
              This is a simple dialog displayed with the Backdrop component. Click anywhere to
              close.
            </Typography>
      ...
      <DemoSection>
        ...
        <Stack direction="row" spacing={2} style={{ flexWrap: 'wrap' }}>
          <FocusEffectsDemo type="outline">Outline Focus</FocusEffectsDemo>

          <FocusEffectsDemo type="ring">Ring Focus</FocusEffectsDemo>

          <FocusEffectsDemo type="glow">Glow Focus</FocusEffectsDemo>

          <FocusEffectsDemo type="border">Border Focus</FocusEffectsDemo>

          <FocusEffectsDemo type="inset">Inset Focus</FocusEffectsDemo>
        </Stack>
      </DemoSection>
