...
const SpringElement = styled.div<{ theme: any, mass: number, stiffness: number, dampingRatio: number }>`
  ${props => springAnimation({
    mass: props.mass,
...
const PhysicsDemo = () => {
    ...
    for (let i = 0; i < 20; i++) {
      ...
      particle.animate(
        [
          ...
          { 
            transform: `translate(${Math.cos(angle) * speed}px, ${Math.sin(angle) * speed}px) scale(0) rotate(${Math.random() * 360}deg)`,
            opacity: 0 
          }
        ],
        {
  ...
  return (
    <DemoContainer>
      ...
      <ControlPanel>
        <Typography variant="h5" style={{ marginBottom: '16px' }}>Control Panel</Typography>
        
        <Stack direction="row" spacing={2} style={{ marginBottom: '16px' }}>
          <Button onClick={resetSprings}>
        ...
        <Typography variant="body2" style={{ marginBottom: '8px' }}>Spring Parameters:</Typography>
      ...
      <DemoSection>
        ...
        <Stack spacing={2}>
          ...
          <SpringElement mass={springMass * 1.5} stiffness={springStiffness * 0.7} dampingRatio={springDamping * 0.7}>
            <Typography variant="body1">Heavy Spring (Slow)</Typography>
          </SpringElement>
          
          <SpringElement mass={springMass * 0.5} stiffness={springStiffness * 1.5} dampingRatio={springDamping * 1.5}>
      ...
      <DemoSection>
        ...
        <Stack spacing={2}>
          <ParticleElement type="confetti" key={`confetti-${particleTrigger}`} onClick={triggerParticles}>
            <Typography variant="body1">Confetti Particles (Click Me)</Typography>
          </ParticleElement>
          
          <ParticleElement type="sparkle" key={`sparkle-${particleTrigger}`} onClick={triggerParticles}>
      ...
      <DemoSection>
        ...
        <Stack direction="row" spacing={3} style={{ flexWrap: 'wrap' }}>
          <InteractionBox
            ref={springHook.ref}
            style={springHook.style}
          >
            <Typography variant="body1">Spring Physics</Typography>
          </InteractionBox>
          
          <InteractionBox
            ref={magneticHook.ref}
            style={magneticHook.style}
          >
          ...
          <InteractionBox
            ref={gravityHook.ref}
            style={gravityHook.style}
          >
            <Typography variant="body1">Gravity Physics</Typography>
          </InteractionBox>
          
          <InteractionBox
            ref={particleHook.ref}
            style={particleHook.style}
          >
