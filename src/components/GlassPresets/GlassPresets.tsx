 ...
 * A minimal, clean glass container with high transparency.
 */
export const CleanGlassContainer = forwardRef<HTMLDivElement, CleanGlassContainerProps>((props, ref) => {
  const {
    baseBlurStrength = 5,
    baseOpacity = 0.1,
 ...
 */
export const FrostedGlassContainer = forwardRef<HTMLDivElement, ContextAwareGlassProps>((props, ref) => {
  const {
    baseBlurStrength = 12,
    baseOpacity = 0.2,
 ...
 */
export const TexturedGlassContainer = forwardRef<HTMLDivElement, ContextAwareGlassProps>((props, ref) => {
  const {
    baseBlurStrength = 8,
    baseOpacity = 0.15,
 ...
 */
export const SubtleGlassContainer = forwardRef<HTMLDivElement, ContextAwareGlassProps>((props, ref) => {
  const {
    baseBlurStrength = 3,
    baseOpacity = 0.08,
 ...
 */
export const StandardGlassContainer = forwardRef<HTMLDivElement, ContextAwareGlassProps>((props, ref) => {
  const {
    baseBlurStrength = 10,
    baseOpacity = 0.15,
 ...
 */
export const ImmersiveGlassContainer = forwardRef<HTMLDivElement, ContextAwareGlassProps>((props, ref) => {
  const {
    baseBlurStrength = 15,
    baseOpacity = 0.12,
    baseBorderOpacity = 0.3,
 ...
 */
export const DashboardGlassContainer = forwardRef<HTMLDivElement, ContextAwareGlassProps>((props, ref) => {
  const {
    baseBlurStrength = 8,
    baseOpacity = 0.15,
    baseBorderOpacity = 0.2,
 ...
 */
export const FormGlassContainer = forwardRef<HTMLDivElement, ContextAwareGlassProps>((props, ref) => {
  const {
    baseBlurStrength = 7,
    baseOpacity = 0.2,
    baseBorderOpacity = 0.25,
 ...
 */
export const ModalGlassContainer = forwardRef<HTMLDivElement, ContextAwareGlassProps>((props, ref) => {
  const {
    baseBlurStrength = 12,
    baseOpacity = 0.2,
    baseBorderOpacity = 0.25,
