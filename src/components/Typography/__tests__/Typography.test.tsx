...
describe('Typography Component', () => {
  ...
  test('respects custom component prop', () => {
    renderWithTheme(
      <Typography component="article">Custom component</Typography>
    );
  ...
  test('applies noWrap style', () => {
    renderWithTheme(
      <Typography noWrap>This text should not wrap</Typography>
    );
...
describe('GlassTypography Component', () => {
  test('renders with glass styling', () => {
    renderWithTheme(
      <GlassTypography>Glass text</GlassTypography>
    );
  ...
  test('passes correct glow and edgeHighlight props to Typography', () => {
    renderWithTheme(
      <GlassTypography>Glass with effects</GlassTypography>
    );
