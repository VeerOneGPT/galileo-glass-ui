...
const Container = styled.div<{
  ...
  max-width: ${props => props.$maxWidth ? (typeof props.$maxWidth === 'number' ? `${props.$maxWidth}px` : props.$maxWidth) : 'none'};
  ...
  /* Scroll fade effect */
  ${props => props.$scrollFade && !props.$reducedMotion && `
    &::after {
      content: '';
      position: fixed;
      left: 0;
  ...
  ${props => props.$dimensionalChildren && `
    & > * {
...
const ContentWrapper = styled.div<{
  ...
  ${props => props.$dimensionalChildren && !props.$reducedMotion && `
    & > * {
