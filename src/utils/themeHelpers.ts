 ...
 */
export function createCompatibleThemeContext(theme: any = {}): Omit<UnifiedThemeContext, 'theme'> & { theme: any } {
...
export function asCompatibleThemeContext(context: any): UnifiedThemeContext {
  ...
  const utilsProps = typeof context.isDarkMode !== 'undefined' && typeof context.theme !== 'undefined';
  const coreProps = typeof context.getColor === 'function' && typeof context.getSpacing === 'function';
  ...
  if (coreProps) {
    ...
    const utilsContext: UtilsThemeContext = {
      ...
      isDarkMode: (context as CoreThemeContext).isDarkMode || (context as CoreThemeContext).colorMode === 'dark',
